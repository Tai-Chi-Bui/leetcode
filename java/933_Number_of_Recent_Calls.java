 ...
 *   the number of requests that have happened in the past 3000 milliseconds (including the new request). Specifically,
 *   return the number of requests that have happened in the inclusive range [t - 3000, t]
 * 
 * Requirements:
 * - Count requests in past 3000 milliseconds
 * - Include current request in count
